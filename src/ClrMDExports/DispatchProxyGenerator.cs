    ...
    internal static class DispatchProxyGenerator
    {
        ...
        private static Type GenerateProxyType(Type baseType, Type interfaceType)
        {
            ...
            if (baseTypeInfo.IsSealed)
            {
                ...
                throw new ArgumentException("BaseType_Cannot_Be_Sealed " + baseTypeInfo.FullName);
            }

            // The base type cannot be abstract
            if (baseTypeInfo.IsAbstract)
            {
                throw new ArgumentException("BaseType_Cannot_Be_Abstract " + baseType.FullName);
            }
            ...
            {
                throw new ArgumentException("BaseType_Must_Have_Default_Ctor " + baseType.FullName);
            }
